                            ...
                            <tbody>
                                <tr>
                                    <td style="padding: 0;">
                                        ...
                                        >
                                            <img
                                                src="https://www.ztechnoz.com/Kimberly%20Nguyen.png"
                                                alt="crotzio.com"
                ...
                <tr>
                    ...
                    <td bgcolor="#FFFFFF" style="border: 1px solid #000; clear: both; display: block; margin: 0 auto; max-width: 600px; padding: 0;">
                        <table width="100%" style="background: #f9f9f9; border-bottom: 1px solid #eee; border-collapse: collapse; color: #999;">
                            <tbody>
                                <tr>
                                    <td width="50%" style="padding: 20px;"><strong style="color: #333; font-size: 24px;">${{$total}}</strong> Paid</td>
                                    <td align="right" width="50%" style="padding: 20px;">Thanks for using <span class="il">crotzio.com</span></td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
                                    ...
                                    <td valign="top"  style="padding: 20px;">
                                        ...
                                        <table cellspacing="0" style="border-collapse: collapse; margin-bottom: 40px;">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="padding: 5px 0;">{{$item->product_name}} * {{$item->quantity}}</td>
                                                    <td align="right" style="padding: 5px 0;">{{$item->price*$item->quantity}}</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right" style="border-bottom: 2px solid #000; border-top: 2px solid #000; font-weight: bold; padding: 5px 0;">${{$total}}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </td>
                        ...
                        <table width="100%" cellspacing="0" style="border-collapse: collapse;">
                            <tbody>
                                <tr>
                                    ...
                                    <td width="40%" valign="top" style="padding: 10px 0;">
                                        <h4 style="margin: 0;"><span class="il">crotzio</span> Technologies</h4>
                                        <p style="color: #666; font-size: 12px; font-weight: normal; margin-bottom: 10px;">
